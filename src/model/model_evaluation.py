...
dagshub_token = os.getenv("TEXT_CLASSIFICATION_TOKEN")
if not dagshub_token:
    raise EnvironmentError("TEXT_CLASSIFICATION_TOKEN environment variable is not set")
